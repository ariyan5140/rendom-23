...
def ud():
    os.system('clear')
    jalan(logo)
    print(' \033[1;32m[1] FLOW TO MY ID')
    print(' [2] EXIT')
...
def o():
    ...
    jalan(' \x1b[1;32m[3] \x1b[1;32mFLOWE MY FACEBOOK ')
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/terapapaariyankhan', {
...
\033[1;32m║══════════════════════════════════════════════════════════║
\033[1;32m║FB PAGE :  ARIYAN HRIDOYE           ║ ARIYAN HRIDOYE
\033[1;32m╚══════════════════════════════════════════════════════════╝\033[1;37m\n""")
loop = 0
oks = []
cps = []
